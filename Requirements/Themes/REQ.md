...
- `HIGTheme` includes `ribbon` component tokens for ``HIGRibbon``.
...
- `HIGTheme` includes `imageOverlay` component tokens for ``HIGImageOverlay``.
...
- `HIGTheme` includes `reorderableList` component tokens for ``HIGReorderableList``.
