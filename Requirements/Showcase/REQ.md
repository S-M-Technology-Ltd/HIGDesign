...
- Demonstrate every public component in realistic HIG contexts (including admin surfaces, wayfinding, timeline, status/empty state, `HIGCloseButton`, and `HIGModal`).
