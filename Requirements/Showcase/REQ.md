...
- Demonstrate every public component in realistic HIG contexts (including `HIGMatrixLoader` patterns, sizes, and seeded selection; `HIGPanel`; `HIGBreadcrumb` / `HIGPageHeader`; `HIGPagination`, `HIGTabs`, and `HIGAccordion`).
