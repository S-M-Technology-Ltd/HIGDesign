...
- Demonstrate every public component in realistic HIG contexts (including `HIGMatrixLoader`; admin surfaces; `HIGPagination` / `HIGTabs` / `HIGAccordion`; `HIGSteps` / `HIGPearlSteps`).
