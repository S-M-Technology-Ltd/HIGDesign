...
- Demonstrate every public component in realistic HIG contexts (including `HIGMatrixLoader` patterns, sizes, and seeded selection; `HIGPanel` with actions/collapse; `HIGBreadcrumb` and `HIGPageHeader`).
