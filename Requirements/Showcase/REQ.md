...
- Demonstrate every public component in realistic HIG contexts (including `HIGInputGroup`, `HIGFieldMessage`, `HIGDatePicker`, `HIGTimePicker`, `HIGSelect`, and `HIGAutocomplete`).
