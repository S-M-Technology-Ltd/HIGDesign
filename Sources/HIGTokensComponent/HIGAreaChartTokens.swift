...
/// Component tokens for ``HIGAreaChart``.
public protocol HIGAreaChartTokens: Sendable {
...
/// System defaults for area charts.
public struct HIGSystemAreaChartTokens: HIGAreaChartTokens, Sendable {
