...
/// Component tokens for ``HIGBarChart``.
public protocol HIGBarChartTokens: Sendable {
...
/// System defaults for bar charts.
public struct HIGSystemBarChartTokens: HIGBarChartTokens, Sendable {
    ...
    public init(
        ...
        emptyFont: Font = .body,
        barCornerRadius: CGFloat = HIGRadius.sm.rawValue
    ) {
