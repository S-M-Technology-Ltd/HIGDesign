...
public protocol HIGPhotoLocalizationProviding: Sendable {
...
public extension HIGPhotoLocalizationProviding {
...
public struct HIGPhotoEnglishLocalizationProvider: HIGPhotoLocalizationProviding {
    public init() {}
...
public struct HIGPhotoChineseLocalizationProvider: HIGPhotoLocalizationProviding {
    public init() {}
...
@available(*, deprecated, renamed: "HIGPhotoLocalizationProviding")
public typealias HIGPhotoLocalizationsProviding = HIGPhotoLocalizationProviding
