...
public struct OnEditorLoadedKey: EnvironmentKey {
    public static let defaultValue: (@MainActor (HIGLongTextEditorView) -> Void)? = nil
}
...
public extension EnvironmentValues {
    ...
    var onEditorLoaded: (@MainActor (HIGLongTextEditorView) -> Void)? {
    ...
    var introspectEditor: (@MainActor (HIGLongTextEditorView) -> Void)? {
