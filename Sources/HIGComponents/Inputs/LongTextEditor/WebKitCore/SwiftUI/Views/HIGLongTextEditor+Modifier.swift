...
public extension View {
    ...
    ///
    /// - Returns: A view that disables or enables the inner scroll of the `HIGLongTextEditorRepresentable` view.
    ...
    ///   receives the `HIGLongTextEditorView` instance representing the loaded editor view.
    ///
    /// - Returns: A view that fires an action when the editor is loaded.
    func onEditorLoaded(perform action: @MainActor @escaping (HIGLongTextEditorView) -> Void) -> some View {
    ...
    /// Performs an action when the editor is initialized, to customize the underlying ``HIGLongTextEditorView``.
    ///
    ...
    func introspectEditor(perform action: @MainActor @escaping (HIGLongTextEditorView) -> Void) -> some View {
